...
local window = kavoUi.CreateLib("JN HH Gaming Hub V8", "BloodTheme")
...
local Tab5Section = Tab5:NewSection("Made By JN HH Gaming")
local Tab5Section = Tab5:NewSection(" Main Helpers - Darlux,Snick,Suntai")
local Tab5Section = Tab5:NewSection("Helpers -7GrandDad,Moerii,vamp,skys")
...
Tab1Section:NewSlider("Sound 1-0", "Adjust killaura sound", 1, 0, function(val)
	...
	Tab1Section:NewToggle("Infinite Jumps"," Infinite Jumps",function(state)
if state then
...
Tab1Section:NewButton("Anti Void"," Opens Anti Void",function()
local specialpos = (workspace.MapCFrames:FindFirstChild("center") and workspace.MapCFrames.center.Value.p == Vector3.new(77, 11, 35))
                        ...
                        AntiVoidP.Position = Vector3.new(0, 15.5, 0)
                    print("...")
                end)

Tab1Section:NewToggle("No KnockBack","No KnockBack",function(state)
if state then
