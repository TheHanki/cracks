...
local window = Library.CreateLib("Games HUB V5 Premuim (Cracked By Hanki)","DarkTheme")
...
local Tab4Section = Tab4:NewSection("Thanks for buying! Enjoy!")
...
loadstring(game:HttpGet(('https://pastebin.com/raw/16t4YGST'),true))()end) 
...
loadstring(game:HttpGet(('https://pastebin.com/raw/ZDD39wMM'),true))()end) 
...
loadstring(game:HttpGet(('https://pastebin.com/raw/ZrrtZhu0'),true))()end)
...
loadstring(game:HttpGet(('https://pastebin.com/raw/ut8Niyxg'),true))()end)
...
loadstring(game:HttpGet(('https://pastebin.com/raw/SKT2Mubm'),true))()end) 
...
loadstring(game:HttpGet(('https://pastebin.com/raw/NCFrCTA5'),true))()end) 
...
loadstring(game:HttpGet(('https://pastebin.com/raw/fyZcYFUX'),true))()end) 
...
loadstring(game:HttpGet("https://pastebin.com/raw/wN9Q3pZm",true))()end) 
...
Tab4Section:NewButton("Admin IV V2","No description",function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/BloodyBurns/Hexx/main/Iv%20Admin/Admin%202.lua'))()
end)

Tab4Section:NewButton("B Genesis HUB (10+ Games)","No description",function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/raw-scriptpastebin/raw/main/B_Genesis'))()
end)

Tab4Section:NewButton("FE Animation R6 GUI","No description",function()
loadstring(game:HttpGet("https://textbin.net/raw/k3sjvw3vrq"))();
end)

Tab4Section:NewButton("FE Walkable Hats","No description",function()
...
Tab4Section:NewButton("Nightmare Hub (Hats need)","No description",function()
loadstring(game:HttpGet(('https://pastefy.ga/lrjtanrp/raw'),true))()
end)

Tab4Section:NewButton("FE Korblox (Headless not FE)","No description",function()
...
Tab4Section:NewButton("FrostM Admin","No description",function()
loadstring(game:HttpGet(('https://pastebin.com/raw/Lqmx6Eiy'),true))();
end)

Tab4Section:NewButton("Fake IP Grabber","No description",function()
local ScreenGui = Instance.new("ScreenGui")
...
Tab4Section:NewButton("Fling GUI R15 R6 (No tool need)","No description",function()
...
Tab4Section:NewButton("Fe Hubs","No description",function()
loadstring(game:HttpGet(('https://raw.githubusercontent.com/Henry887/RemX-Script-Hub/main/main.lua'),true))()
end)

Tab4Section:NewButton("Netless V3","No description",function()
...
Tab4Section:NewButton("GrabKnife (Not Fe)","No description",function()
--e = Kill 
--q = Fix Knife
...
Tab4Section:NewButton("Gamepass Gui","No description",function()
-- Gui to Lua
-- Version: 3.2
...
Tab4Section:NewButton("FE Chat Bypass","No description",function()
loadstring(game:GetObjects("rbxassetid://1262435912")[1].Source)()
end)

Tab4Section:NewButton("FE Headless","No description",function()
local lp = game:GetService "Players".LocalPlayer
if lp.Character:FindFirstChild "Head" then
    local char = lp.Character
    char.Archivable = true
...
Tab4Section:NewButton("FE Emotes Gui","No description",function()
local animations = {
