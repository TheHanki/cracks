...
local window = kavoUi.CreateLib("Games HUB Destroyer V3 Premium (Cracked By Hanki)","DarkTheme")
...
Tab1Section:NewButton("Build A Boat For Treasure (FIXED)","No description",function()
...
Tab4Section:NewButton("B Genesis HUB (Blox Fruits)","No description",function()
