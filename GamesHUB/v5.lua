...
local Library = DarkraiX:Window("Games HUB V5 (Cracked By Hanki)","","",Enum.KeyCode.RightControl);
...
Tab3:Seperator("Games HUB V5")

Tab3:Line()

Tab3:Seperator("--- Added more games (Not many)")

Tab3:Seperator("--- Added My scripts window")

Tab3:Seperator("--- Name changed (UI problems)")

Tab3:Seperator("--- Bugs fixed")

Tab3:Seperator("--- Support Hydrogen/Fluxus")
...
Tab4:Button("Fire X Hub",function()
